    ...
    REGISTER_GROUPS: List[RegisterGroup] = [
        ...
        RegisterGroup(
            ...
            [
                ...
                Register(
                    "SoC", "SoC", ModbusTcpClient.DATATYPE.UINT16, lambda v: v, "%"
                ),
                Register(
